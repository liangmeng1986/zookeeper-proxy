...
public class TestZookeeperDemo extends TestZookeeper {  
    
    private static Log log = LogFactory.getLog(TestZookeeperDemo.class.getName());  
    ...
    public byte[] getData(String path) throws KeeperException, InterruptedException {     
     ...
     public static void main(String[] args) {  
         try {     
        	 TestZookeeperDemo zkoperator             = new TestZookeeperDemo();     
                zkoperator.connect("127.0.0.1:29181");  
